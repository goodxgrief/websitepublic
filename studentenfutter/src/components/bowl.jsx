...
import '../assets/styles/bowls.css';
        ...
        <div className="bowls-grid">
          ...
          <div className="bowl-card" style={{animationDelay: "0s"}}>
            <div className="image-wrapper">
              <img 
                loading="lazy" 
                src="https://tb-static.uber.com/prod/image-proc/processed_images/fc820e600487e0eca99e24c60930b17b/bc9c318a9c96996e2d990faf2b0c65f6.jpeg" 
          ...
          <div className="bowl-card" style={{animationDelay: "0.2s"}}>
            <div className="image-wrapper">
              <img 
                loading="lazy" 
                src="https://images.unsplash.com/photo-1572441710555-2d0fc8f40274?auto=format&fit=crop&w=400&q=80" 
                alt="Mexikanische Fiesta Bowl" 
              />
            </div>
